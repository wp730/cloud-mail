const en = {
    ...
    oidcEnable: 'Enable OIDC',
    oidcEndpoint: 'Endpoints',
    oidcIssuerDesc: 'Issuer, leave blank to use the current site address',
    oidcConsentTip: '{name} wants to access your account',
    oidcConsentAccount: 'Signed in as',
    oidcApprove: 'Authorize',
    oidcDeny: 'Deny',
    oidcReqInvalid: 'The authorization request is invalid or expired',
    oidcScope_openid: 'Verify your identity',
    oidcScope_profile: 'Read your name and avatar',
    oidcScope_email: 'Read your email address',
    oidcScope_offlineaccess: 'Stay signed in while you are away',
    oidcLogoutDone: 'You have been signed out',
    oidcBackLogin: 'Back to sign in',
    oidcSearchDesc: 'Search by app name',
    oidcNoClient: 'No apps found',
    oidcAddClient: 'Add App',
    oidcEditClient: 'Edit App',
    oidcAppName: 'App name',
    oidcAppDesc: 'App description',
    oidcAppLogo: 'App logo URL',
    oidcRedirectUris: 'Redirect URIs',
    oidcRedirectUrisDesc: 'Redirect URIs, one per line',
    oidcPostLogoutUrisDesc: 'Post logout redirect URIs, one per line',
    oidcScopes: 'Scopes',
    oidcClientType: 'Client type',
    oidcConfidentialClient: 'Confidential',
    oidcPublicClient: 'Public',
    oidcSkipConsent: 'Skip consent',
    oidcCopyClientId: 'Copy client_id',
    oidcCopySecret: 'Copy client_secret',
    oidcResetSecret: 'Reset client_secret',
    oidcResetSecretConfirm: 'The old secret stops working immediately. Continue?',
    oidcSecretTitle: 'Client Secret',
    oidcSecretTip: 'Save it now, it will not be shown again here',
    oidcAppNameEmpty: 'App name is required',
    oidcRedirectUriEmptyMsg: 'At least one redirect URI is required'
}
