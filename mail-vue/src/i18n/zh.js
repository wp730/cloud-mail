const zh = {
    ...
    userEmail: '用户邮箱',
    oidcApp: 'OIDC应用',
    oidcProvider: 'OIDC认证服务',
    oidcEnable: '开启OIDC',
    oidcEndpoint: '端点地址',
    oidcIssuerDesc: 'Issuer, 留空则使用当前站点地址',
    oidcConsentTip: '{name} 请求访问你的账号',
    oidcConsentAccount: '当前账号',
    oidcApprove: '授权',
    oidcDeny: '拒绝',
    oidcReqInvalid: '授权请求无效或已过期',
    oidcScope_openid: '验证你的身份',
    oidcScope_profile: '读取你的昵称和头像',
    oidcScope_email: '读取你的邮箱地址',
    oidcScope_offlineaccess: '在你离线时保持登录',
    oidcLogoutDone: '你已退出登录',
    oidcBackLogin: '返回登录',
    oidcSearchDesc: '搜索应用名称',
    oidcNoClient: '没有任何应用',
    oidcAddClient: '添加应用',
    oidcEditClient: '修改应用',
    oidcAppName: '应用名称',
    ...
    oidcRedirectUrisDesc: '回调地址, 一行一个',
    oidcPostLogoutUrisDesc: '登出后跳转地址, 一行一个',
    oidcScopes: '授权范围',
    oidcClientType: '客户端类型',
    oidcConfidentialClient: '机密客户端',
    oidcPublicClient: '公开客户端',
    oidcSkipConsent: '免确认授权',
    oidcCopyClientId: '复制client_id',
    oidcCopySecret: '复制client_secret',
    oidcResetSecret: '重置client_secret',
    oidcResetSecretConfirm: '重置后旧密钥立即失效, 是否继续',
    oidcSecretTitle: '客户端密钥',
    oidcSecretTip: '请立即保存, 关闭后需重新查看',
    oidcAppNameEmpty: '应用名称不能为空',
    oidcRedirectUriEmptyMsg: '回调地址不能为空'
}
export default zh
